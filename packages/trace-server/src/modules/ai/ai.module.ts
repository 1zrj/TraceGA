...
@Module({
  ...
  providers: [AiAnalyzeService, DailyReportService, AnomalyExplainService, NlQueryService, RecommendService, GlmClientService, PromptService],
  exports: [AiAnalyzeService, DailyReportService, AnomalyExplainService, NlQueryService, RecommendService],
})
